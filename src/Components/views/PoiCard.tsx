...
const description =
  'Tontokrom is a small town located in the Amansie South District in the Ashanti Region of Ghana.[1][2][3] It is mostly known for its gold and has recently been noted for the menace of illegal mining popularly called galamsey.[4] (Wikipedia)';
    ...
    <div className="poi-card flex flex-c other-gray">
      ...
      <div className="poi-content flex flex-c">
        <div className="header flex flex-r">
          <div className="left">Tontokrom, Ghana</div>
          <div className="right"></div>
        </div>
